...
# 使用测试集进行验证
arg2_r = sess.run(arg2,feed_dict={images_input:test_images,labels_input:test_labels})
arg1_r = sess.run(arg1,feed_dict={images_input:test_images,labels_input:test_labels})
print("测试集分类报告:")
print(classification_report(arg1_r, arg2_r))  # 打印分类报告
print("混淆矩阵:")
print(confusion_matrix(arg1_r, arg2_r)/sum(confusion_matrix(arg1_r, arg2_r)))  # 打印混淆矩阵
